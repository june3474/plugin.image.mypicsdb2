...
class Main:
    ...
    def add_directory(self, name, params, action, iconimage=None, fanart=None,
        ...
        try:
            ...
            if path:
                ...
                u = sys.argv[0] + "?" + parameter + "&action=" + repr(str(action)) + "&name=" + \
    ...
    def show_folders(self):
        ...
        if not self.args.folderid:  # No Id given, get all folders
            ...
            childrenfolders = [row for row in
                               MPDB.cur.request("SELECT idFolder,FolderName FROM Folders WHERE ParentFolder is null")]
        ...
        for idchildren, childrenfolder in childrenfolders:
            ...
            if count > 0:
                self.add_directory(name="%s (%s %s)" % (childrenfolder, count, common.getstring(30050)),  # libellé
                                   params=[("method", "folders"), ("folderid", str(idchildren)), ("onlypics", "non"),
                                           ("viewmode", "view")],
                                   # paramètres
    ...
    def show_translationeditor(self):
        ui = translationeditor.TranslationEditor("script-mypicsdb-translationeditor.xml", common.getaddon_path(),
                                                 "Default")
        ui.doModal()
        del ui
